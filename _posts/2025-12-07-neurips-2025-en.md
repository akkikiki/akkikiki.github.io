---
layout: post
title: Thoughts on NeurIPS 2025
...
1. General impressions:
    1. There were an incredible number of people! Nearly 30,000 participants including virtual and in-person attendance.
...
2. Setting up 1:1 meetings
    ...
    2. Searching for #NeurIPS2025 on Twitter (formerly), I found quite a few participants posting "feel free to reach out," so I set up meetings within my capacity.
...
4. Simultaneous presentations of the diffusion language model [LLaDA 8B](https://arxiv.org/abs/2502.09992) and research using it
    ...
    1. This is my personal impression, but it reminded me of NAACL 2019 when BERT was presented, but it had already been buzzing since 2018, so BERT itself, its analysis, and papers using BERT were all presented at the same conference. Déjà vu.
        1. My understanding of the rough historical flow of language models is: n-gram language models → (solving other NLP tasks with SVM/CRF/LDA, etc.) → word2vec/RNN → LSTM → BERT (this one) → GPT-1/2/3 → ChatGPT/GPT-3.5 → ... Whether this is a stage that will continue to grow remains to be seen.
    ...
    3. I requested several 1:1 meetings, and the most interesting was the [paper on Uniform State Diffusion Model](https://arxiv.org/pdf/2506.10892) (not from NeurIPS) that was introduced to me during one of them.
...
2. Other/Misc
    1. When I attended WWW 2016 as an auditor in the past, there weren't many language processing presentations and I didn't know many people, so it wasn't very interesting, but NeurIPS was personally interesting. Especially since LLMs are now incorporated as modules regardless of whether they're for images, audio, or video, there were hardly any irrelevant presentations.

## Final Remark
Thank you to everyone who met, talked, and discussed with me on-site.

If you are looking for someone to collaborate, don't hesitate to contact me at fujinumay at gmail dot com!
