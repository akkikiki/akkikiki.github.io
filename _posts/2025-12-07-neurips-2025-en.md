...
5. Uniform State Diffusion Language Model
    ...
    3. Uniform-State Diffusion naturally models re-masking (the method of replacing tokens that have once transitioned from [MASK] tokens to non-mask tokens back to [MASK] tokens again) (it doesn't use [MASK] tokens to begin with).
