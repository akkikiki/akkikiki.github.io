...
4. **Simultaneous presentations of the diffusion language model [LLaDA 8B](https://arxiv.org/abs/2502.09992) and papers building on top of it** 
    ...
    1. This is my personal impression, but it reminded me of NAACL 2019 when BERT was presented, but it had already been buzzing since the arXiv/Github debut in 2018, so BERT itself, its analysis, and papers using BERT were all presented at the same conference. Déjà vu.
...
5. **Uniform State Diffusion Language Model**
    ...
    4. By the way, not directly related to the conference, but [Between Diffusion Language Models and Autoregressive Models (In Japanese)](https://prednext.com/blog/diffusion-language-model-2/) was also interesting. My personal impression is that uniform-state diffusion is one possible next topic of this blog.
